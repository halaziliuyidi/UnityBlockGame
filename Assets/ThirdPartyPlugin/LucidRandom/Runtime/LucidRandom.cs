...
namespace AnnulusGames.LucidTools.RandomKit
{
    public static class LucidRandom
    {
        ...
        public static List<T> RandomDisticncElements<T>(WeightedList<T> weightedList,int count)
        {
            return instance.RandomDisticncElements(weightedList,count);
        }
        ...
        public static List<T> RandomDisticncElements<T>(IEnumerable<T>values, int count)
        {
            return instance.RandomDisticncElements(values, count);
        }
